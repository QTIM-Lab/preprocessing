...
def launch_slurm(
    ...
    primary_job = run(f"sbatch {primary_jobfile}", capture_output=True, shell=True)
    ...
    aggregation_job = run(f"sbatch {aggregation_jobfile}", capture_output=True, shell=True)
